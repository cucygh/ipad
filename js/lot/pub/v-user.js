define(['backbone', 'zepto', 'm-user', 'user-tpl','lottery'], function (Backbone, $, Login, TplLogin,Lot) {
	...
	var Vlogin = Backbone.View.extend({
			...
			login_call : function (e) {
				var tpl_login = '<div class="quick_item quick_history"><a href="http://cp.360.cn/pfchongzhi" target="_blank" class="quick_link"><i class="ico_history_26"></i><span class="quick_txt">充值</span><i class="divide"></i></a></div><div class="quick_item quick_attention"><a href="http://cp.360.cn/pftikuan" target="_blank" class="quick_link _checklogin"><i class="ico_collect_26"></i><span class="quick_txt">提现</span><i class="divide"></i></a></div><div class="quick_item quick_attention"><a href="http://cp.360.cn/pfbet"  target="_blank" class="quick_link _checklogin"><i class="ico_message_26"></i><span class="quick_txt">记录</span><i class="divide"></i></a></div><div class="quick_item quick_attention"><a href="http://cp.360.cn/kj/kaijiang.html" target="_blank" class="quick_link _checklogin"><i class="ico_upload_26"></i><span class="quick_txt">开奖</span><i class="divide"></i></a></div><div class="quick_item quick_user open"><a href="#" class="quick_link"><img src="{img_url}" alt="用户名" title="{user}"></a></div><div class="quick_item"><div class="user_name"><a href="http://cp.360.cn/pfbet">{user}</a></div><div class="user_exit"><a href="#" class="exit">退出</a></div></div>';
